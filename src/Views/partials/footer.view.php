	...
	<footer id="footer">
		...
		<div class="col-full">
			...
			<div id="credit" class="col-right">
				<?php if ( '' != $settings['connect_twitter'] || '' != $settings['connect_facebook'] || '' != $settings['connect_linkedin'] ) { ?>
				<div class="footer-social">
		   		    ...
		   		    <?php if ( '' != $settings['connect_linkedin'] ) { ?><a href="<?php echo esc_url( $settings['connect_linkedin'] ); ?>" class="linkedin" title="<?php esc_attr_e( 'Follow on Twitter', 'woothemes' ); ?>"></a><?php } ?>
				</div>
				<?php } ?>
...
<footer><p>ToDoList-Gamer - LePoleS</p></footer>
</body>
</html>